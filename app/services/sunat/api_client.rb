        ...
        items: sale.items.includes(:product).map do |item|
          {
            ...
            unit_price_without_tax: PeruTax.base_unit_price(item.unit_price).to_s("F"),
            tax_type: "gravado"
          }
        end
      }
      ...
      payload = {
        ...
        items: credit_note.items.map do |item|
          tax_type = item.tax_type || "gravado"
          {
            ...
            unit_price: item.unit_price.to_f,
            unit_price_without_tax: PeruTax.base_unit_price(item.unit_price, tax_type: tax_type).to_s("F"),
            tax_type: tax_type
          }
        end
      }
